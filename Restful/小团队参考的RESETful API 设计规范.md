...
- [api.example.com/getUserInfo…](https://api.example.com/getUserInfo?userid=1)
- [api.example.com/getusers](https://api.example.com/getusers)
- [api.example.com/sv/u](https://api.example.com/sv/u)
- [api.example.com/cgi-bin/use…](https://api.example.com/cgi-bin/users/get_user.php?userid=1)

再来看一个正列

- [api.example.com/zoos](https://api.example.com/zoos)
- [api.example.com/animals](https://api.example.com/animals)
- [api.example.com/zoos/{zoo}/…](https://api.example.com/zoos/{zoo}/animals)
- [api.example.com/animal_type…](https://api.example.com/animal_types)
- [api.example.com/employees](https://api.example.com/employees)
