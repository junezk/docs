...
![正向代理与反向代理](Nginx 从入门到实践.assets/171c4e96d99eecdc)
...
![2020-03-09-负载均衡](Nginx 从入门到实践.assets/2020-03-09-负载均衡.png)

### 2.5 动静分离

为了加快网站的解析速度，可以把动态页面和静态页面由不同的服务器来解析，加快解析速度，降低原来单个服务器的压力。

![2020-03-09-动静分离](Nginx 从入门到实践.assets/2020-03-09-动静分离.png)
...
![image-20200307180412726](Nginx 从入门到实践.assets/171c4e967ad35156)
...
![image-20200307180545816](Nginx 从入门到实践.assets/171c4e967cd99d22)

### 3.2 相关文件夹

然后我们可以使用 `rpm -ql nginx` 来查看 Nginx 被安装到了什么地方，有哪些相关目录，其中位于 `/etc` 目录下的主要是配置文件，还有一些文件见下图：

![Xnip2020-03-07_21-46-11](Nginx 从入门到实践.assets/171c4e969c75753f)
...
![image-20200426150644768](Nginx 从入门到实践.assets/171c4e96a168c66a)
...
![image-20200426153006505](Nginx 从入门到实践.assets/171c4e96a60a5e51)
...
![image-20200311153131642](Nginx 从入门到实践.assets/171c4e96a6d7033c)
...
![image-20200427220536208](Nginx 从入门到实践.assets/171c4e96b16214cc)
...
![image-20200428191153736](Nginx 从入门到实践.assets/171c4e96b99b44b7)
...
![image-20200428192028636](Nginx 从入门到实践.assets/171c4e96c8e70d22)
...
![image-20200427110415809](Nginx 从入门到实践.assets/171c4e96dc471f0b)
...
![image-20200427161022215](Nginx 从入门到实践.assets/171c4e96dd2b5019)

配置之后 response 的 header 里面多了一个 `Content-Encoding: gzip`，返回信息被压缩了：

![image-20200427164033577](Nginx 从入门到实践.assets/171c4e96def4db0f)

注意了，一般 gzip 的配置建议加上 `gzip_min_length 1k`，不加的话：

![image-20200427164408389](Nginx 从入门到实践.assets/171c4e96ee3279e8)
...
![image-20200427144824829](Nginx 从入门到实践.assets/171c4e96f98708c7)
...
![2020-03-13-双机热备 (Nginx 从入门到实践.assets/2020-03-13-双机热备 (1).png)](../../../2020-03-13-双机热备 (1).png)
...
![62haogU3DtwMRiZ](Nginx 从入门到实践.assets/171c4e97062c5124)
