...
> 定义：一个类只负责一项职责，不要存在 1 个以上导致类发生变更的原因。
...
![img](设计模式六大原则.assets/2012110231.jpg)
...
![img](设计模式六大原则.assets/2012110232.jpg)
...
> 定义：一个对象应该对其他对象保持最少的了解，尽量减少对其他类的依赖，尽量减少对外暴露的方法，使得功能模块独立，低耦合。
...
![img](设计模式六大原则.assets/2012110233.jpg)

图中的每一条维度各代表一项原则，我们依据对这项原则的遵守程度在维度上画一个点，则如果对这项原则遵守的合理的话，这个点应该落在红色的同心圆内部；如果遵守的差，点将会在小圆内部；如果过度遵守，点将会落在大圆外部。一个良好的设计体现在图中，应该是六个顶点都在同心圆中的六边形。

![img](设计模式六大原则.assets/2012110234.jpg)
