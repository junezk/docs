...
![已上传分片列表](大规格文件的上传优化.assets/bVbG5Ub)
...
![上传分片](大规格文件的上传优化.assets/bVbG5Ud)
...
![上传进度](大规格文件的上传优化.assets/1460000022624802)
...
![merge](大规格文件的上传优化.assets/bVbG5Uf)

![图片](大规格文件的上传优化.assets/bVbG5Ug)
