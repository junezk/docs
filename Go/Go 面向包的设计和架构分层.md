...
> 该文和Go工程化——project Layout最佳实践内容类似，应该这篇是源头
...
最后以软件大师 [Kent Beck](https://baike.baidu.com/item/Kent Beck/13006051?fr=aladdin) 在《重构Refactoring》一书中描述的结尾。
